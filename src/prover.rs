...
impl Prover<'_> {
    ...
    fn add_proposition(&mut self, proposition: AcornValue) {
        ...
        let new_clauses = self.normalizer.normalize(self.env, proposition);
...
mod tests {
    ...
    fn test_specialization() {
        ...
        assert_eq!(Prover::prove_theorem(&env, "goal", true), Outcome::Success);
    }
    ...
    fn test_backward_specialization_fails() {
        ...
        assert_eq!(Prover::prove_theorem(&env, "goal", true), Outcome::Failure);
    }
    ...
    fn test_proof_inside_theorem_block() {
        ...
        assert_eq!(
            Prover::prove(&env, "reflexivity(t)", true),
            Outcome::Success
        );
    }
    ...
    fn test_proof_inside_forall_block() {
        ...
        assert_eq!(
            Prover::prove(&env, "((x = t) -> foo(x))", true),
            Outcome::Success
        );
    }
    ...
    fn test_proof_inside_if_block() {
        ...
        assert_eq!(Prover::prove(&env, "(x = y)", true), Outcome::Success);
    }
    ...
    fn test_proving_add_zero_right() {
        let env = snap_env();
        assert_eq!(
            Prover::prove_theorem(&env, "add_zero_right", true),
            Outcome::Success
        );
    }
    ...
    fn test_proving_add_suc_right() {
        let env = snap_env();
        assert_eq!(
            Prover::prove_theorem(&env, "add_suc_right", true),
            Outcome::Success
        );
    }
